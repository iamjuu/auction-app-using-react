...
const [menu,setMenu]=useState([false])
  ...
  return (
    ...
    <div className='flex flex-wrap  gap-5 w-full '>
      <a href="javascript:void(0)"><p  className='text-blue-700 text-lg font-bold hover:translate-x-[10p] hover:translate-y-[10px] delay-200 duration-200 '>Auction</p>
      </a>
      ...
      <div id="collapseMenu"
        ...
        <ul
          ...
          <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
              className='lg:hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]'>Help</a>
          </li>
        </ul>
      </div>
  
      <button  onClick={()=>setMenu(!menu)} id="toggleOpen" className='lg:hidden ml-auto text-2xl'>
       {menu ?
       <div><FaTimes className='text-xl'  />
